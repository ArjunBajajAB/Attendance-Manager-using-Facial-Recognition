...
class AttendanceManager(object):
    ...
    def ProceedPage(self):
        ...
        self.EnterSemester = Entry(self.main_frame,bd=3,bg="black",fg="white")
        ...
        self.ResetButton = Button(self.main_frame, text="Reset", activebackground="grey", bd=3, bg="White",
                                         fg="Black", font=self.ButtonFont, justify=RIGHT, height=1, width=8,command=self.Reset)
        ...
        self.ContinueButton= Button(self.main_frame, text="Continue", activebackground="grey", bd=3, bg="White",
                                         fg="Black", font=self.ButtonFont, justify=RIGHT, height=1, width=8,command=self.Continue)
    ...
    def Reset(self):
        self.EnterSemester.delete("0","end")
    ...
    def Continue(self):
        ...
        if self.RollNo.isdigit() and int(len(self.RollNo)) == 11 and self.Name.isalpha():
            ...
            self.Check_Your_AttendanceButton = Button(self.main_frame, text="Check your attendance", activebackground="grey", bd=3, bg="White",
                                         fg="Black", font=self.ButtonFont, justify=RIGHT, height=1, width=25,command=self.Check_Attendance)
            ...
            self.Mark_Your_AttendanceButton= Button(self.main_frame, text="Mark your attendance", activebackground="grey", bd=3, bg="White",
                                         fg="Black", font=self.ButtonFont, justify=RIGHT, height=1, width=25,command=self.Mark_Attendance)
    ...
    def ShowAttendance(self):
        ...
        if self.subject == "Select":
            ...
            self.alert.destroy()
            self.ShowSubjectAttendance = Label(self.main_frame, text="Your attenadance of " + self.subject + " is ", bg="black", fg="white", font=self.TextFont)
