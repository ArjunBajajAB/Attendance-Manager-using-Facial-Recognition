...
class AttendanceManager(object):
    ...
    def FirstPage(self):
        ...
        self.ProceedButton = Button(self.content_frame, text="Proceed", activebackground="grey", bd=3, bg="White",
                                    fg="Black",
                                    command=self.ProceedPage, font=self.ButtonFont, justify=CENTER, height=1, width=7)
        self.ProceedButton.place(x=0, y=25)
        self.AboutButton = Button(self.content_frame, text="About", activebackground="grey", bd=3, bg="White",
                                  fg="Black",
    ...
    def ProceedPage(self):
        ...
        self.EnterSemester = OptionMenu(self.main_frame, self.SelectSemester, "I", "II", "III", "IV", "V", "VI", "VII",
                                        "VIII")
        ...
        self.BackButton = Button(self.main_frame, text="Back", activebackground="grey", bd=3, bg="White",
                                 command=self.FirstPage,
                                 fg="Black", font=self.ButtonFont, justify=RIGHT, height=1, width=7)
    ...
    def ContinuePage(self):
        ...
        if self.RollNo.isdigit() and int(len(
                self.RollNo)) == 1 and self.Name.isalpha() and self.Semester != "Select" and self.Course != "Select":
    ...
    def Check_AttendancePage(self):
        ...
        self.SelectSubject = Label(self.content_frame, text="Select subject :", bg="black", fg="white",
                                   font=self.TextFont)
    ...
    def AboutPage(self):
        ...
        self.AboutInfo = Message(self.content_frame, bg="Black", fg="White", font=self.TextFont, justify=CENTER,
                                 width=600,
                                 text=self.about)
